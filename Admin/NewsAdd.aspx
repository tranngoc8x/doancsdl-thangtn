<%@ Page Language="C#" MasterPageFile="~/Admin/PageAdmin.master" AutoEventWireup="true" CodeFile="NewsAdd.aspx.cs" Inherits="Admin_NewsAdd" Title="Untitled Page" %>
...
<div class="content-box-content">
	...
	<div class="notification attention png_bg" style="opacity: 0;display:none;" id="notification">
...
<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
	...
	<p>
		<asp:Button ID="btn_update" runat="server" class="button" Text="Thêm mới" onclick="btn_ins_Click" />
	</p>
</fieldset>
...
<div class="clear">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="A_TinTuc_Add" InsertCommandType="StoredProcedure" 
        SelectCommand="SELECT TinTuc.* FROM TinTuc">
        <InsertParameters>
            <asp:ControlParameter ControlID="tieude" Name="tieude" Type="String" PropertyName="Text" />
            <asp:ControlParameter ControlID="tomtat" Name="tomtat" Type="String" PropertyName="Text" />
            <asp:ControlParameter ControlID="noidung" Name="noidung" Type="String" PropertyName="Text"  />
            <asp:ControlParameter  ControlID="file" Name="anh" Type="String" PropertyName="FileName" />
            <asp:ControlParameter DefaultValue="0" ControlID="noibat" Name="noibat" 
                Type="Int32" PropertyName="Text" />
            <asp:ControlParameter DefaultValue="1" ControlID="trangthai" Name="trangthai" 
                Type="Int32" PropertyName="Text"  />
        </InsertParameters>
    </asp:SqlDataSource>
