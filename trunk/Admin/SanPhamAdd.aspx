<%@ Page Language="C#" MasterPageFile="~/Admin/PageAdmin.master" AutoEventWireup="true" CodeFile="SanPhamAdd.aspx.cs" Inherits="Admin_SanPhamAdd" Title="Thêm sản phẩm" %>
...
<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
	...
	<p>
		...
		<asp:TextBox TextMode="multiline" class="text-input textarea wysiwyg" 
            id="noidung" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="noidung" ID="RequiredFieldValidator5" runat="server" ErrorMessage="* Chi tiết sản phẩm không được để trống"></asp:RequiredFieldValidator> 
	</p>
	<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:TNTCOMPUTERConnectionString %>" 
        InsertCommand="A_SanPham_Them" InsertCommandType="StoredProcedure" 
        SelectCommand="SELECT SanPham.* FROM SanPham">
        <InsertParameters>
            ...
            <asp:ControlParameter Name="Feature" Type="Byte" ControlID="noibat" 
            ...
            <asp:ControlParameter ControlID="giamgia" Name="Giamgia" PropertyName="Text" 
                Type="Decimal" />
             <asp:ControlParameter ControlID="noidung" Name="Chitiet" PropertyName="Text" 
                Type="String" />
        </InsertParameters>
    </asp:SqlDataSource>
        </div>
